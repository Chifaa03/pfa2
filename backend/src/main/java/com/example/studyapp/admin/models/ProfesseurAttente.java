...
@Document(collection = "professeurs_attente")
public class ProfesseurAttente {
    @Id
    private String id;
    ...
    public ProfesseurAttente(String id, String firstName, String lastName, String email, String password,
