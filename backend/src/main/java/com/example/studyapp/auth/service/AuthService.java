package com.example.studyapp.auth.service;

import com.example.studyapp.auth.dto.ReqRes;
import com.example.studyapp.auth.model.OurUsers;

import com.example.studyapp.auth.repository.OurUserRepo;
...
public class AuthService {
    ...
    public ReqRes signUp(ReqRes registrationRequest){
        ...
        try {
            ...
            ourUsers.setPictureUrl(registrationRequest.getPictureUrl());
            ourUsers.setBirthday(registrationRequest.getBirthday());
            ourUsers.setSpeciality(registrationRequest.getSpeciality());
            System.out.println(registrationRequest.getSpeciality());
